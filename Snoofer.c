...
int main(int argc, char** args) {
    ...
    printf("\n    Snoofer Application;  Copyright (C) 2023  Roy Simanovich and Yuval Yurzdichinsky\n"
...
void packetSniffer(u_char *args, const struct pcap_pkthdr *header, const u_char *packet) {
    ...
    const struct icmphdr* icmph = (struct icmphdr*)(packet + sizeof(struct ethhdr) + iph->ihl*4);
